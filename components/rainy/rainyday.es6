...
class RainyDay {
     ...
     */
    updateCanvasImage (newImg) {

        // update options about newImg
        this.options.crop = [0, 0, newImg.naturalWidth, newImg.naturalHeight]
        this.options.width = newImg.clientWidth
        this.options.height = newImg.clientHeight
